...
public class Haus {
    final private int DEFAULT_TUEREN = 1;
    final private int DEFAULT_FENSTER = 1;
    final private int DEFAULT_ETAGEN = 1;
    final private int DEFAULT_FLAECHE = 100;
    final private String DEFAULT_STRASSE = "Coblitzallee";
    final private String DEFAULT_HAUSNUMMER = "7";
    final private int DEFAULT_PLZ = 69782;
    final private String DEFAULT_ORT = "Mannheim";
